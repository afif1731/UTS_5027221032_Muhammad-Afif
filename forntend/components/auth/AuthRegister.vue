        ...
        <div class="form-div ">
            ...
            <div class="d-flex justify-content-center align-items-center h-75 mt-5">
                <form class="buat-form border rounded rounded-3">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputName1" class="form-label text-center">User Name</label>
                        <input type="name" class="form-control" id="inputname" v-model="username" required />
                    </div>
                    <div class="mb-3">
                    ...
                    <div>
                        <p class="my-2 text-center question">Already Have an Account? <NuxtLink class="linkin" to="/login">Login Here</NuxtLink></p>
                    </div>
